...
const TAG_RULES = [
  ...
  ['Meat & Seafood', /\bmeats?\b|\bpoultry\b|\bchickens?\b|\bbeef\b|\bpork\b|\bturkeys?\b|\bsausages?\b|\bbacon\b|\bseafood\b|\bfish(es)?\b|\bshrimps?\b|\bsalmon\b|\btuna\b|\bcanned fish\b/],
...
const NAME_RULES = [
  ...
  ['Beverages', /\bjuice\b|sparkling|\bwater\b|\bsoda\b|\bcoffee\b|\bteas?\b|kombucha|\bwine\b|\bbeer\b|\bcider\b|oat milk|almond milk|lemonade|cold brew|\bmilk\b(?! chocolate)/i],
  ...
  ['Meat & Seafood', /chicken(?! broth| stock)|\bbeef\b(?! broth)|\bpork\b|turkey|sausage|bacon|salmon|shrimp|\btuna\b|steak|\blamb\b|meatball|\bfish\b|\bhot dogs?\b/i],
  ...
  ['Produce', /\bsalad\b|\bherbs?\b|mushroom|potato(?! chips)|\bonions?\b|tomato(?! sauce| paste)|avocado|berries|\bapples?\b|\bbananas?\b|lettuce|broccoli|cauliflower(?! gnocchi| pizza)|\bpeppers?\b(?!mint)|\bgrapes\b|\blemons?\b|\blimes?\b|\bspinach\b|\bkale\b|\bcarrots?\b|\bfigs?\b|\bcuties\b|\bmandarins?\b/i],
];
